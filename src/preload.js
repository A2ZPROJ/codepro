...
window.electronAPI = {
  ...
  orcElev: {
    ...
    fornecedoresDel:  (id)=> ipcRenderer.invoke('orc-elev:fornecedores-del', id),
    fornecedoresUpdate: (id,f)=> ipcRenderer.invoke('orc-elev:fornecedores-update', id, f),
    abrirLink:      (url) => ipcRenderer.invoke('orc-elev:open-external', url),
